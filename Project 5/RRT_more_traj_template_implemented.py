...
Fast_RRT = False #true for fast rrt, false for basic rrt
...
TestCaseCOOR = [9.5, 7.5]  # <---------------------TESTER PUT INITIAL X,Y COORDINATE PT HERE
RPM1 = 10
RPM2 = 20
FinalStateCOOR = [5,1]  # <-------------------TESTER PUT GOAL X,Y COORDINATE PT HERE
