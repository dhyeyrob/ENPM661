...
Fast_RRT = True #true for fast rrt, false for basic rrt <------------TESTER SET FAST/BASIC RRT FLAG HERE
...
TestCaseCOOR = [5,1]  # <---------------------TESTER PUT INITIAL X,Y COORDINATE PT HERE
FinalStateCOOR = [9.5, 7.5]  # <-------------------TESTER PUT GOAL X,Y COORDINATE PT HERE
